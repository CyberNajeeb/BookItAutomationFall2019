...
public class APIStepDefinitions {
    ...
    public void user_should_be_able_to_see_rooms(int expectedNumberOfRooms) {
        List<Object> rooms = response.jsonPath().get();//get() will automatically determine the right data type (List, String, etc.).
    ...
    public void user_verifies_that_response_status_code_is(int expectedStatusCodes) {
        Assert.assertEquals(expectedStatusCodes, response.getStatusCode());
    }
